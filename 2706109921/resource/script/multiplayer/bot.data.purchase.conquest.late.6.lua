	...
	{--purchase 8 infantry attack 2
		...
		Units = {
			...
			--Infantry
				...
				{priority = 1.5, class = UnitClass.Infantry, unit = "single_sniper(jap)"},
			--Wheel_vehicles
				{priority = 1.5, class = UnitClass.Vehicle, unit = "type93"},
				{priority = 1.0, class = UnitClass.Vehicle, unit = "type94aa"},
			--Tanks_light
				{priority = 1.0, class = UnitClass.Tank, unit = "type94_te-ke"},
				{priority = 1.0, class = UnitClass.Tank, unit = "type97_te-ke"},
				{priority = 1.0, class = UnitClass.Tank, unit = "type95_ha-go"},
			},
			["usa"] = {--USA
			--Infantry
				-- 1
