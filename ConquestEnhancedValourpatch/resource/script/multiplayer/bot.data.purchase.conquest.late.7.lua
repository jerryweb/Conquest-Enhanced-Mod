Purchases["campaign_capture_the_flag"] = {
	...
	{--purchase 2 mortar
		...
		Units = {
			...
			--Howitzers
				...
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "107mm_mk_ii"},
			},
			["ita"] = {--Italy
			--Howitzers	
		...
		Units = {
           ...
           --HMGs
			...
			--Howitzers
				...
				{priority = 1.0, class = UnitClass.AATank, unit = "bl45_pol"},
			...
			--Howitzers			
                ...
                {priority = 1.0, class = UnitClass.AATank, unit = "37_mm_m3"},
	...
	{--purchase 9 rocket arty
		...
		Units = {
			...
			["usa"] = {--USA
			--Howitzers			
                {priority = 0.5, class = UnitClass.ArtilleryTank, unit = "203_mm_m115"},	
	...
	{--purchase 10 light tank rush
		...
		Units = {
			...
			--Wheel_vehicles
				...
				{priority = 1.0, class = UnitClass.Vehicle, unit = "m3halftrack_pol"},
				{priority = 1.0, class = UnitClass.Vehicle, unit = "staghound_pol"},
				{priority = 1.0, class = UnitClass.Vehicle, unit = "bedford_ql_art"},
				{priority = 1.0, class = UnitClass.Vehicle, unit = "bedford_ql_inf"},
			--Tanks_light
				{priority = 1.0, class = UnitClass.AATank, unit = "crusader_aa2_pol"},
				{priority = 1.0, class = UnitClass.Tank, unit = "crusader_pol"},
			},
