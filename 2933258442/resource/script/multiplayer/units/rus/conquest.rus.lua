	...
	{Repeat = 0, --infinite
        Units = {
			...
			-- Infantry
				...
				{priority = 2.0, type = {"Infantry", "Squad", "Wave",}, unit = "squad_conscripts_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Super_Wave",}, unit = "squad_partisan_wave_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Super_Wave",}, unit = "squad_nkvd_rifle_wave_con(rus)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_recon_44_con(rus)"},
				...
				{priority = 3.5, type = {"Infantry", "Squad",}, unit = "squad_rifle_43_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_rifle_43_heavy_con(rus)"},
				{priority = 3.5, type = {"Infantry", "Squad",}, unit = "squad_rifle_44_con(rus)"},

				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_smg_con(rus)"},
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_smg_mg_43_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_smg_mg_43_heavy_con(rus)"},
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_smg_mg_44_con(rus)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_guardsrifle_44_con(rus)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_marines_con(rus)"},

				--T4+
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_guards_paras_con(rus)"},
				...
				{priority = 0.5, type = {"Infantry", "Team", "Engineer",}, unit = "single_engineer(rus)"},
				{priority = 1.5, type = {"Infantry", "Team", "Flamer"}, unit = "single_flamer(rus)"},
			...
			-- Cannons
				...
				{priority = 0.5, type = {"Cannon", "Artillery", "Big_gun",}, unit = "300mm_m30"},
				{priority = 0.1, type = {"Cannon", "Artillery", "Big_gun",}, unit = "300mm_m31"},
				--]]
			...
			-- Tanks
				...
				{priority = 0.5, type = {"Tank", "Light",}, unit = "m3a1_stuart_rus"},
				...
				{priority = 0.1, type = {"Tank", "Medium", "Elite",}, unit = "t3485_44a"},
				{priority = 0.1, type = {"Tank", "Medium", "Elite",}, unit = "t3485_44b"},
				{priority = 0.5, type = {"Tank", "Medium", "Elite", "Flamer",}, unit = "t3485_44_flame"},
				{priority = 0.1, type = {"Tank", "Medium", "Elite", "Flamer",}, unit = "t3485_44a_flame"},
				{priority = 1.0, type = {"Armored", "MG", "Deminer",}, unit = "t34m"},
				{priority = 0.5, type = {"Tank", "Heavy", "Elite",}, unit = "churchill3"},
			...
			--Aircraft
				...
				{priority = 0.8, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "il2_mod42_x1", maxUnitCount = 2, multiplier = 1},
				{priority = 0.7, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "il2_mod42_x2", maxUnitCount = 4, multiplier = 2},
				{priority = 0.6, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "il2_mod42_x3", maxUnitCount = 6, multiplier = 3},
				{priority = 1.0, type = {"Aircraft", "ReconPlane",}, unit = "po2_x1"},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_rus_paras_con", multiplier = 4},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_rus_paras_con_late", multiplier = 4},
			---]====]
			--MACE
