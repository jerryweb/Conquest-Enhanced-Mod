	...
	{Repeat = 0, --infinite
        ...
        Units = {
			...
			-- Infantry
				...
				{priority = 1.5, type = {"Infantry", "Squad","Wave",}, unit = "squad_45th_rifle_con(usa)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Flamer",}, unit = "squad_82nd_glider_pio_con(usa)"},
				...
				--T4
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_ranger_assault_con(usa)"},
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_ranger_assault_mg_con(usa)"},
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_ranger_assault_late_con(usa)"},
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_ranger_assault_mg_late_con(usa)"},
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_ranger_special_late_con(usa)"},

				{priority = 1.5, type = {"Infantry", "Squad", "Flamer",}, unit = "squad_82nd_eng_con(usa)"},
				...
				{priority = 0.5, type = {"Infantry", "Team", "Engineer",}, unit = "single_engineer(usa)"},
				{priority = 1.5, type = {"Infantry", "Team", "Flamer",}, unit = "single_flamer(usa)"},
			...
			-- Tanks
				...
				{priority = 0.5, type = {"Tank", "Medium", "Elite",}, unit = "m4a3_75w_e4_5"},
				{priority = 1.5, type = {"Tank", "Medium", "Support", "Elite", "Big_gun",}, unit = "m4a3_105"},
				{priority = 2.0, type = {"Tank", "Medium", "Support", "Elite", "Big_gun",}, unit = "m4a3_105_hvss"},
				...
				{priority = 0.5, type = {"Tank", "Heavy", "Elite",}, unit = "m26_pershing"},
				{priority = 0.1, type = {"Tank", "Heavy", "Elite",}, unit = "t26e4"},
				{priority = 0.1, type = {"Tank", "Medium", "Deminer",}, unit = "t1e3_m4a1_75"},
				--]]
			...
			---]====]
			--Aircraft
				{priority = 1.0, type = {"Aircraft", "Fighter",}, unit = "p47_d22_ai", maxUnitCount = 2},
				{priority = 1.0, type = {"Aircraft", "Bomber",}, unit = "p47_d22_bomber_ai", maxUnitCount = 1},
				{priority = 0.8, type = {"Aircraft", "Fighter",}, unit = "p47_d22_ai_x3", maxUnitCount = 6, multiplier = 3},
				{priority = 0.15, type = {"Aircraft", "Bomber",}, unit = "p47_d22_bomber_ai_x2", maxUnitCount = 4, multiplier = 2},	
				...
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_101st_paras_glider_con_x2", multiplier = 2},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_101st_paras_eng_con_x2", multiplier = 2},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_101st_paras_con_x2", multiplier = 2},
			---STUFF
