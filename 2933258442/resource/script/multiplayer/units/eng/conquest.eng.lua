	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				--T1
				{priority = 1.0, type = {"Infantry", "Squad", "Wave",}, unit = "squad_rear_echelon_early_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Wave",}, unit = "squad_brig_defense_mid_con(eng)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_vet_rifle_late_con(eng)"},

				--T3
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_51hl_rifle_early_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_com_early_con(eng)"}, --stealth

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_7th_ad_rifle_mid_con(eng)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_1st_airland_rifle_mid_con(eng)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_6th_airland_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_gds_ad_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_com_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_com_smg_s_late_con(eng)"},

				--T3+
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_51hl_rifle_mid_con(eng)"},

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_7th_ad_rifle_late_con(eng)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_airland_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_1st_airland_support_late_con(eng)"},

				--T4
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_hl_bw_rifle_early_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_hl_bw_inf_pio_early_con(eng)"},
 
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_recce_mid_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_mid_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_com_rifle_mid_con(eng)"}, --stealth
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_sas_mid_con(eng)"}, --stealth

				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_6th_para_eng_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_6th_para_rifle_late_con(eng)"},

				{priority = 1.0, type = {"Infantry", "Squad","AT", "Elite",}, unit = "squad_1st_para_at_late_con(can)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_1st_para_protect_late_con(can)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(can)"},

				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_eng_late_con(pol)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Flamer", }, unit = "squad_1st_para_eng_flame_late_con(pol)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(pol)"},

				--T4+
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_eng_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_recce_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_sas_late_con(eng)"}, --stealth

				--Singles/Teams
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_at_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_at1_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_at2_con(eng)"},
				
				--{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_medic(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "AT",}, unit = "single_riflegrenade_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_ap_miner(eng)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_at_miner(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "Engineer"}, unit = "single_engineer(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "Flamer",}, unit = "single_flamer(eng)"},
				--{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_tankman(eng)"},
				{priority = 1.0, type = {"Infantry", "Team",}, unit = "single_sniper(eng)"},
				{priority = 1.0, type = {"Infantry", "Team", "Signaller",}, unit = "single_signaller(eng)"},
				--]]
			...
			-- Cannons
				...
				--HMGs
				{priority = 1.0, type = {"Cannon", "MG",}, unit = "vickers_mg"},
				--Anti Aircraft
				{priority = 1.0, type = {"Cannon", "AA",}, unit = "20mm_polsten"},
				{priority = 1.0, type = {"Cannon", "AA",}, unit = "20mm_oerlikon"},
				{priority = 1.0, type = {"Cannon", "AA",}, unit = "40mm_qf40_early"},
				{priority = 1.0, type = {"Cannon", "AA",}, unit = "40mm_qf40"},
				{priority = 1.0, type = {"Cannon", "AA",}, unit = "94mm_qf_3_7_aa_early"},
				{priority = 1.0, type = {"Cannon", "AA", "AT",}, unit = "94mm_qf_3_7_aa_mid"},
				{priority = 1.0, type = {"Cannon", "AA", "AT",}, unit = "94mm_qf_3_7_aa_late"},
				--Anti Tank
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "37mm_qf_mk1"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "40mm_qf2_early"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "40mm_qf2_mid"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "40mm_qf2_late"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "40mm_qf2_littlejohn_mid"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "40mm_qf2_littlejohn_late"},
				...
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "76mm_qf17_25"},
				...
				--Mortars
				{priority = 1.0, type = {"Cannon", "Mortar",}, unit = "81mm_ml3_early"},
				{priority = 1.0, type = {"Cannon", "Mortar",}, unit = "81mm_ml3"},
				{priority = 1.0, type = {"Cannon", "Mortar",}, unit = "107mm_ml4_2"},
				--Infantry Support
				{priority = 1.0, type = {"Cannon", "Support",}, unit = "75mm_m1a1_eng"},
				{priority = 1.0, type = {"Cannon", "Support",}, unit = "84mm_qf18_2pa"},
				{priority = 1.0, type = {"Cannon", "Support",}, unit = "94mm_qf_how_early"},
				{priority = 1.0, type = {"Cannon", "Support",}, unit = "94mm_qf_how"},
				--Artillery
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "84mm_qf18_5p"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "88mm_qf25_mk1_4p"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "88mm_qf25_mk2"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "88mm_qf25_mk2_late"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_qf_how_wooden"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_qf_how"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_bl_4_5_mk1"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_bl_4_5"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "140mm_bl_5_5"},
				...
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "183mm_bl_7_2"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "183mm_bl_7_2_mk6"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "203mm_bl_8"},
				--Rocket Artillery
			...
			-- Wheel vehicles
				...
				{priority = 1.0, type = {"Vehicle", "AA",}, unit = "morris_c9_aa"},
	
				{priority = 1.0, type = {"Armored", "MG",}, unit = "morris_cs9"},

				{priority = 1.0, type = {"Armored", "MG",}, unit = "daimler_dingo_boys"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "daimler_dingo_early"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "daimler_dingo"},

				{priority = 1.0, type = {"Armored", "MG",}, unit = "humber_recon_mk2"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "humber_recon_mk3"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "humber_scout"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "humber_mk2"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "humber_mk4"},

				{priority = 1.0, type = {"Armored", "AT",}, unit = "daimler_mk1"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "daimler_mk1_lj"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "daimler_mk2"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "daimler_mk2_lj"},

				{priority = 1.0, type = {"Armored", "AT",}, unit = "aec_mk1"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "aec_mk2"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "aec_mk3"},

				{priority = 1.0, type = {"Armored", "AT",}, unit = "staghound_mk1"},
				{priority = 1.0, type = {"Armored", "Support",}, unit = "staghound_mk2"},
				{priority = 1.0, type = {"Armored", "AT",}, unit = "staghound_mk3"},
				{priority = 1.0, type = {"Armored", "AA",}, unit = "staghound_mkaa"},
				--]]

			-- Halftracks
				---[[
				{priority = 1.0, type = {"Armored", "MG",}, unit = "universal_carrier_mk1"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "mmg_carrier_mk1"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "universal_carrier_mk2"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "mmg_carrier_mk2"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "wasp_mk2c"},

				{priority = 1.0, type = {"Armored", "MG", "Transport",}, unit = "m5_halftrack"},
				{priority = 1.0, type = {"Armored", "MG", "Transport",}, unit = "m5a1_halftrack"},
				{priority = 1.0, type = {"Armored", "MG", "Transport",}, unit = "lvt4_eng"},
				--]]

			-- Tanks
				---[[
				{priority = 1.0, type = {"Tank", "Light", "MG",}, unit = "vickers_mk6"},
				{priority = 1.0, type = {"Tank", "Light", "AA",}, unit = "vickers_aa_mk1"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "cruiser_mk1"},
				...
				{priority = 1.0, type = {"Tank", "Light", "Support",}, unit = "cruiser_mk2a_cs"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "cruiser_mk3"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "cruiser_mk3_late"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "cruiser_mk4"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "cruiser_mk4a"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "matilda1"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "matilda1_50"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "stuart1"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "stuart3"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "stuart5"},
				{priority = 1.0, type = {"Tank", "Light", "MG",}, unit = "stuart5_recce"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "stuart6"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "tetrarch_mk7"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "tetrarch_mk7_littlejohn"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "m22_locust"},

				{priority = 1.0, type = {"Tank", "Medium",}, unit = "matilda2_mk1"},
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "matilda2_mk3"},
				{priority = 1.0, type = {"Tank", "Medium","Support",}, unit = "matilda2_mk4_cs"},
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "crusader_mk1"},
				{priority = 1.0, type = {"Tank", "Medium", "Support",}, unit = "crusader_mk1_cs"},
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "crusader_mk2"},
				{priority = 1.0, type = {"Tank", "Medium", "Support",}, unit = "crusader_mk2_cs"},
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "crusader_mk3"},
				{priority = 1.0, type = {"Tank", "Medium", "AA",}, unit = "crusader_aa_mk1"},
				{priority = 1.0, type = {"Tank", "Medium", "AA",}, unit = "crusader_aa_mk2"},

				{priority = 1.0, type = {"Tank", "Medium",}, unit = "valentine_mk1"},
				...
				{priority = 1.0, type = {"Tank", "Medium", "Elite",}, unit = "comet1_a34"},
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "challenger_a30"},

				{priority = 1.0, type = {"Tank", "Medium",}, unit = "grant"},
				...
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "sherman2a"},
				...
				{priority = 1.0, type = {"Tank", "Heavy", "Support",}, unit = "churchill_mk4_avre"},
				{priority = 1.0, type = {"Tank", "Heavy", "Support",}, unit = "churchill_mk5"},
				{priority = 1.0, type = {"Tank", "Heavy", "Elite",}, unit = "churchill_mk7"},
				{priority = 1.0, type = {"Tank", "Heavy", "Flamer",}, unit = "churchill_mk7_croc"},
				{priority = 1.0, type = {"Tank", "Heavy", "Support",}, unit = "churchill_mk8"},
				--]]

			-- Self-Propelled Guns
				---[[
				{priority = 1.0, type = {"Tank", "Medium", "AT",}, unit = "wolverine_mk1"},
				{priority = 1.0, type = {"Tank", "Medium", "AT",}, unit = "achilles_mk2"},
				{priority = 1.0, type = {"Tank", "Medium", "AT",}, unit = "archer"},

				{priority = 1.0, type = {"Tank", "Medium", "Artillery",}, unit = "bishop"},
				{priority = 1.0, type = {"Tank", "Medium", "Artillery",}, unit = "sexton_mk2"},
				--]]
			---]====]
			--Aircraft
				...
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1strecon_x1", multiplier = 4},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1statcan_x1", multiplier = 4},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1stpol_x1", multiplier = 4},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1stpoleng_x1", multiplier = 4},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_6th_x1", multiplier = 4},
				{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_SAS_x1", multiplier = 4},
