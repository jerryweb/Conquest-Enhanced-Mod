	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_rec_scout_early_con(eng)"}, --vehicle

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_recce_assault_mid_con(eng)"},
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_recce_carrier_mid_con(eng)"}, --vehicle

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_recce_assault_late_con(eng)"},
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_recce_assault_mot_late_con(eng)"}, --vehicle
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_recce_carrier_late_con(eng)"}, --vehicle
				...
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_carrier_early_con(eng)"}, --vehicle
				...
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_carrier_mid_con(eng)"}, --vehicle

				{priority = 3.5, type = {"Infantry", "Squad",}, unit = "squad_rifle_late_con(eng)"},
				{priority = 0.5, type = {"Infantry", "Squad", "Mechanized_Infantry",}, unit = "squad_rifle_mot_late_con(eng)"}, --vehicle
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_airland_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_1st_airland_support_late_con(eng)"},

				--T4
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_hl_bw_rifle_early_con(eng)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_mid_con(eng)"},
				{priority = 0.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_com_rifle_mid_con(eng)"}, --stealth
				{priority = 0.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_sas_mid_con(eng)"}, --stealth

				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_6th_para_eng_late_con(eng)"},
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_6th_para_rifle_late_con(eng)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(can)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(pol)"},

				--T4+
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_eng_late_con(eng)"},
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_rifle_late_con(eng)"},
				{priority = 1.0, type = {"Infantry", "Squad", "Elite",}, unit = "squad_1st_para_recce_late_con(eng)"},
				{priority = 0.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_sas_late_con(eng)"}, --stealth
				...
				{priority = 0.75, type = {"Infantry", "Team", "Engineer"}, unit = "single_engineer(eng)"},
				{priority = 1.5, type = {"Infantry", "Team", "Flamer",}, unit = "single_flamer(eng)"},
			...
			-- Tanks
				...
				{priority = 1.5, type = {"Tank", "Medium", "Elite",}, unit = "comet1_a34"},
				...
				{priority = 0.5, type = {"Tank", "Medium", "Flamer",}, unit = "sherman5_croc"},
				...
				{priority = 2.0, type = {"Tank", "Heavy", "Elite",}, unit = "churchill_mk7"},
				{priority = 2.0, type = {"Tank", "Heavy", "Flamer",}, unit = "churchill_mk7_croc"},
			...
			---]====]
			-- CE Units
				{priority = 0.75, type = {"Infantry", "Team", "Signaller",}, unit = "single_signaller(eng)"},
				{priority = 0.1, type = {"Tank", "Medium",}, unit = "cromwell4_tulip"},

			--Aircraft
				-- {priority = 0.6, type = {"Aircraft", "Fighter",}, unit = "typhoon_mk1b", maxUnitCount = 3},
				-- {priority = 0.6, type = {"Aircraft", "Fighter",}, unit = "hurricane_mk1a", maxUnitCount = 3},
				-- {priority = 0.6, type = {"Aircraft", "Fighter", "Group_Air"}, unit = "typhoon_mk1b_x3", maxUnitCount = 6, multiplier = 3},
				-- {priority = 0.6, type = {"Aircraft", "Fighter", "Group_Air"}, unit = "hurricane_mk1a_x3", maxUnitCount = 6, multiplier = 3},
				{priority = 0.65, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "typhoon_mk1b_x1", maxUnitCount = 2},
				{priority = 0.8, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "hurribomber_mk2c_x1", maxUnitCount = 2},
				{priority = 0.7, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "hurribomber_mk2c_x2", maxUnitCount = 2, multiplier = 2},
				{priority = 0.6, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "hurribomber_mk2c_x3", maxUnitCount = 6, multiplier = 3},
				-- {priority = 0.6, type = {"Aircraft", "Bomber",}, unit = "hurribomber_mk2c", maxUnitCount = 2},
	            {priority = 0.6, type = {"Aircraft", "ReconPlane",}, unit = "typhoon_mk1b_recon_x1"},
				...
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1strecon_mid_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1st_mid_x1", multiplier = 3},	
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1strecon_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1statcan_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1stpol_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_1stpoleng_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_6th_x1", multiplier = 3},
				{priority = 0.4, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "ai_paradrop_eng_SAS_x1", multiplier = 3},
