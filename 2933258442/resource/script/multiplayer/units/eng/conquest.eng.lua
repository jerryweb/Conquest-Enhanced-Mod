Purchases["conquest.eng"] = {
	{Repeat = 0, --infinite
		Units = {
			...
			--Aircraft
				{priority = 0.6, type = {"Aircraft", "Fighter",}, unit = "typhoon_mk1b_ai", maxUnitCount = 3},
				{priority = 0.6, type = {"Aircraft", "Fighter",}, unit = "hurricane_mk1a_ai", maxUnitCount = 3},
				{priority = 0.6, type = {"Aircraft", "Fighter", "Group_Air"}, unit = "typhoon_mk1b_ai_x3", maxUnitCount = 6, multiplier = 3},
				{priority = 0.6, type = {"Aircraft", "Fighter", "Group_Air"}, unit = "hurricane_mk1a_ai_x3", maxUnitCount = 6, multiplier = 3},
				{priority = 0.8, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "hurribomber_mk2c_ai_x2", maxUnitCount = 4, multiplier = 2},
				{priority = 0.6, type = {"Aircraft", "Bomber",}, unit = "hurribomber_mk2c_ai", maxUnitCount = 2},
	            {priority = 0.6, type = {"Aircraft", "ReconPlane",}, unit = "blenheim_mk1_eng_recon_ai"},
