	...
	{Repeat = 0, --infinite
		Units = {
			...
			--Aircraft
				...
				{priority = 0.7, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "hurribomber_mk2c_x2", maxUnitCount = 4, multiplier = 2},
	            ...
	            {priority = 0.6, type = {"Aircraft", "ReconPlane",}, unit = "blenheim_mk1_eng_recon"},
