	...
	{Repeat = 0, --infinite
        Units = {
			...
			-- Infantry
				...
				{priority = 1.0, type = {"Infantry", "Squad", "Wave",}, unit = "squad_penal_mid_con(fin)"},
				...
				-- {priority = 1.0, type = {"Infantry", "Squad", "Engineer",}, unit = "squad_heavy_engineer_mid_con(fin)"},
			...
			-- Cannons
				...
				--HMGs
				{priority = 1.0, type = {"Cannon", "MG",}, unit = "maxim_m32_33"},
				{priority = 1.0, type = {"Cannon", "MG",}, unit = "maxim_m1910_30"},
				{priority = 1.0, type = {"Cannon", "MG",}, unit = "mg08_fin"},
				...
				{priority = 1.0, type = {"Cannon", "AA", "AT",}, unit = "76mm_itk31"},
				--Anti Tank
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "20mm_l39"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "25mm_pstk37"},
				...
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "76mm_k00"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "76mm_k02"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "76mm_k02_mid"},
				{priority = 1.0, type = {"Cannon", "AT",}, unit = "76mm_k02_late"},
				...
				{priority = 1.0, type = {"Cannon", "Mortar",}, unit = "300mm_krh42"},
				--Infantry Support
				...
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "105mm_h33"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "105mm_k34"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "107mm_k10"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_h18_how_mid"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "114mm_h18_how_late"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "120mm_k78_31"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "122mm_m1910_fin"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "150mm_h40"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "155mm_h17"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "155mm_k17"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "203mm_h17"},
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "210mm_h17"},
				--Rocket Artillery
				{priority = 1.0, type = {"Cannon", "Artillery",}, unit = "150mm_rkh41"},
				--]]

			-- Wheeled vehicles
				---[[
				{priority = 1.0, type = {"Vehicle", "AA",}, unit = "ford_3ton_breda"},
				{priority = 1.0, type = {"Vehicle", "AA",}, unit = "volvo_127d_itk40"},
				{priority = 1.0, type = {"Armored", "MG",}, unit = "l182"},
				{priority = 1.0, type = {"Armored",}, unit = "ba6_fin"},
				{priority = 1.0, type = {"Armored",}, unit = "ba10_fin"},
				{priority = 1.0, type = {"Armored",}, unit = "ba10_fin_mid"},
				{priority = 1.0, type = {"Armored",}, unit = "ba10m_fin"},
			...
			-- Tanks
				...
				{priority = 1.0, type = {"Tank", "Light",}, unit = "t26e_mid"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "t26_33_fin"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "t26_33_fin_mid"},
				{priority = 1.0, type = {"Tank", "Light",}, unit = "t26c"},
				...
				{priority = 1.0, type = {"Tank", "Medium",}, unit = "t3476_41_fin_late"},
				...
				{priority = 1.0, type = {"Tank", "Heavy",}, unit = "kv1_40e_fin_late"},
				{priority = 1.0, type = {"Tank", "Heavy",}, unit = "kv1_42_fin"},
				{priority = 1.0, type = {"Tank", "Heavy",}, unit = "kv1_42_fin_late"},
				--]]

			-- Self-Propelled Guns
				---[[
				{priority = 1.0, type = {"Tank", "Medium", "AT",}, unit = "stug3g_fin_early"},
