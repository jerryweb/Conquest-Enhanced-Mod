Purchases["conquest.ger"] = {
	{
		...
		Units = {
			...
			-- Infantry
				...
				--T1
				{priority = 1.5, type = {"Infantry", "Squad", "Wave",}, unit = "squad_osttruppen_con(ger)"},
				{priority = 0.8, type = {"Infantry", "Squad", "Wave",}, unit = "squad_strafbatallion_con(ger)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_gebirgsjaeger_late_con(ger)"},
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_gebirgs_recon_late_con(ger)"},
				...
				{priority = 1.5, type = {"Infantry", "Squad", "Elite",}, unit = "squad_fallschirmjaeger_con(ger)"},
				...
				{priority = 1.5, type = {"Infantry", "Team", "Flamer",}, unit = "single_flamer(ger)"},
				...
				{priority = 0.5, type = {"Infantry", "Team", "Engineer"}, unit = "single_engineer(ger)"},
			--]]
		-- Cannons
			...
			{priority = 0.1, type = {"Cannon", "Mortar", "Big_gun",}, unit = "200mm_ldgw40"},
			--Infantry Support
			{priority = 1.5, type = {"Cannon", "Support",}, unit = "75mm_leig18"},
			{priority = 0.5, type = {"Cannon", "Support",}, unit = "75mm_lg40"},
			{priority = 0.5, type = {"Cannon", "Support", "Big_gun",}, unit = "150mm_sig33"},
			--Artillery
		...
		-- Halftracks
			...
			-- {priority = 0.5, type = {"Armored", "Artillery", "Rocket_Arty",}, unit = "sdkfz251d_1_stuka"},
			...
			-- {priority = 0.5, type = {"Armored", "Artillery", "Rocket_Arty",}, unit = "panzerwerfer42"},
		-- Tanks
			...
			{priority = 0.1, type = {"Tank", "Light", "Artillery", "Rocket_Arty",}, unit = "pz38h_w40"},
			...
			{priority = 0.5, type = {"Tank", "Medium", "Flamer",}, unit = "panzer3_flamm"},
			...
			{priority = 2.5, type = {"Tank", "Heavy", "Elite",}, unit = "panzer5g"},
		...
		-- Self-Propelled Guns
			...
			{priority = 0.1, type = {"Tank", "Light", "AT",}, unit = "grille_m"},
			{priority = 0.1, type = {"Tank", "Light", "Support", "Big_gun",}, unit = "bison"},
			...
			{priority = 2.0, type = {"Tank", "Medium", "Support", "Big_gun",}, unit = "stuh42"},
			{priority = 0.1, type = {"Tank", "Medium", "Support", "Big_gun",}, unit = "sig33b"},
