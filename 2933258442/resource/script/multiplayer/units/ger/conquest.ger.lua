Purchases["conquest.ger"] = {
	{
		...
		--Aircraft
			...
			{priority = 1.0, type = {"Aircraft", "Fighter", "Group_Air"}, unit = "bf109_f4_ai_x3", maxUnitCount = 2},
			{priority = 0.5, type = {"Aircraft", "Bomber", "Group_Air"}, unit = "bf110_e2_ai_x3", maxUnitCount = 1},
			{priority = 0.5, type = {"Aircraft", "Fighter", "Bomber", "Group_Air"}, unit = "fighter_bomber_squad", maxUnitCount = 1},
			{priority = 1.0, type = {"Aircraft", "Bomber",}, unit = "bf110_e2_ai", maxUnitCount = 1},
            {priority = 1.0, type = {"Aircraft", "ReconPlane",}, unit = "ai_fi156"},

			{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_fallschirmjaeger_para_con_x3"},
			{priority = 0.5, type = {"Aircraft", "Paratrooper", "Group_Air",}, unit = "squad_fallschirmjaeger_para_con_late_x3"},
		--STUFF
