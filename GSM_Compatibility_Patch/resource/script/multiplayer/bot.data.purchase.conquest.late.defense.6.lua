Purchases["campaign_capture_the_flag"] = {
	{--purchase 1  arty
		...
		Units = {
			["ger"] = {--Germany
		        {priority = 1.0, class = UnitClass.ArtilleryTank, unit = "300mm_nebelwerfer42ai", isHeavyArty = true},
		        {priority = 0.5, class = UnitClass.ATTank, unit = "210mm_morser18ai", isHeavyArty = true},
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "150mm_sfh18ai", isHeavyArty = true},
			},
			["hun"] = {--Hungary
			--Infantry
			...
			["rus"] = {--Russia
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "bm31_12ai", isHeavyArty = true},
				{priority = 1.0, class = UnitClass.ArtilleryTank, unit = "152mm_ml20ai", isHeavyArty = true},
				{priority = 0.5, class = UnitClass.ATTank, unit = "203mm_b4ai", isHeavyArty = true},
			},
			["fra"] = {--France
			--Howitzers
