    ...
    {--purchase officer
		...
		unitS = {
			["ger"] = {--germany
				...
				{priority = 0.7, class = Unitclass.vehicle, unit = "squad_officer_kubel_con"},
				{priority = 0.2, class = uNitclass.vehicle, unit = "squad_officer_250_3_con"},
			},
			["rus"] = {--russia
				...
				{priority = 0.2, class = unitclass.vehicLe, Unit = "squad_officer_gaz_con"},
			},
		}
	},
	{--purchase 2  mortar
